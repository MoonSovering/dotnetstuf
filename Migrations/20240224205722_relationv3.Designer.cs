...
namespace MedicalCenter.Migrations
{
    ...
    [Migration("20240224205722_relationv3")]
    partial class relationv3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalCenter.Models.Doctor", b =>
                {
                    ...
                    b.HasIndex("SpecialityID1")
                        .IsUnique()
                        .HasFilter("[SpecialityID1] IS NOT NULL");
            ...
            modelBuilder.Entity("MedicalCenter.Models.Doctor", b =>
                {
                    ...
                    b.HasOne("MedicalCenter.Models.Speciality", null)
                        .WithOne("Doctor")
                        .HasForeignKey("MedicalCenter.Models.Doctor", "SpecialityID1");
